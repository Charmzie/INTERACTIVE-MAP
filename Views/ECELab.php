...
$query = "SELECT * FROM add_class WHERE room = 'ECELab'";
...
<html>
<head>
    <title>Electronics Engineering Laboratory Schedule</title>
    <style>
        table {
...
<body>
<h2>Schedule for Electronics Engineering Laboratory</h2>
<table>
    <tr>
