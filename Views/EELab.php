...
$query = "SELECT * FROM add_class WHERE room = 'EELab'";
...
<html>
<head>
    <title>Electrical Engineering Laboratory Schedule</title>
    <style>
        table {
...
<body>
<h2>Schedule for Electrical Engineering Laboratory</h2>
<table>
    <tr>
