...
$query = "SELECT * FROM add_class WHERE room = 'MELab'";
...
<html>
<head>
    <title>Mechanical Engineering Laboratory Schedule</title>
    <style>
        table {
...
<body>
<h2>Schedule for Mechanical Engineering Laboratory</h2>
<table>
    <tr>
