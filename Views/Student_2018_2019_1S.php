...
// Query to fetch data
$sql = "SELECT `Program Description`, `Program ID`, `Number of Students`, `Academic Year` FROM `Student_Info_2018_2019_1S`";
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
          $sql = "SELECT `Program Description`, `Number of Students` FROM `Student_Info_2018_2019_1S`"; 
    ...
    <div class="header-container">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="Student_2018_2019_1S.php">First Semester</a>
                <a href="Student_2018_2019.php">Second Semester</a>
            </div>
        </div>
    </div>
