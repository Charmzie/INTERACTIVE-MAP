...
// Query to fetch data
$sql = "SELECT `Program Description`, `Program ID`, `Number of Students`, `Academic Year` FROM `Student_Info_2019_2020_Sum`";
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
          $sql = "SELECT `Program Description`, `Number of Students` FROM `Student_Info_2019_2020_Sum`"; 
    ...
    <div class="header-container">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="Student_2019_2020_1S.php">First Semester</a>
                <a href="Student_2019_2020.php">Second Semester</a>
                <a href="Student_2019_2020_Sum.php">Summer</a>
            </div>
        </div>
    </div>
