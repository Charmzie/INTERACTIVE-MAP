...
// Query to fetch data
$sql = "SELECT `Program Description`, `Program ID`, `Number of Students`, `Academic Year` FROM `Student_Info_2023_2024_Sum`";
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
          $sql = "SELECT `Program Description`, `Number of Students` FROM `Student_Info_2023_2024_Sum`"; 
    ...
    <div class="header-container">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="Student_2023_2024_1S.php">First Semester</a>
                <a href="Student_2023_2024.php">Second Semester</a>
                <a href="Student_2023_2024_Sum.php">Summer</a>
            </div>
        </div>
    </div>
