...
// Query to fetch data
$sql = "SELECT `Program Description`, `Program ID`, `Number of Student`, `Academic Year` FROM `Student_Info_2024_2025`";
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
          $sql = "SELECT `Program Description`, `Number of Student` FROM `Student_Info_2024_2025`"; 
          $fire = mysqli_query($conn, $sql);
          while ($row = mysqli_fetch_assoc($fire)){
              echo "['".$row['Program Description']."', ".$row['Number of Student']."],";
          }
          ?>
        ]);
    ...
    <div class="header-container">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="Student_2024_2025_1S.php">First Semester</a>
                <a href="Student_2024_2025.php">Second Semester</a>
                <a href="Student_2024_2025_Sum.php">Summer</a>
            </div>
        </div>
    </div>
        ...
        <table>
            ...
            <?php while($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($row["Number of Student"]) ?></td>
